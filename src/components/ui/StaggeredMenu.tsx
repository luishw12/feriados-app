...
const MENU_OPEN_CLASS = 'staggered-menu-open';
...
export default function StaggeredMenu({
  ...
  className,
  logoUrl,
  menuButtonColor = '#525252',
  openMenuButtonColor = '#059669',
  accentColor = '#10b981',
  ...
  const layerColors = (() => {
    const raw = colors && colors.length ? colors.slice(0, 4) : ['#34d399', '#059669'];
    const arr = [...raw];
    if (arr.length >= 3) {
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Navegação mobile">
        {logoUrl ? (
