...
export function buildLlmsTxt(siteUrl: string, year: number): string {
  ...
  const lines: string[] = [
    ...
    `- [Hub de guias](${siteUrl}/guia/): calendário, dias úteis, facultativos, emendas, próximo feriado e datas móveis`,
    `- [Sobre o projeto](${siteUrl}/sobre/): open source, contribuição e FAQ do site`,
